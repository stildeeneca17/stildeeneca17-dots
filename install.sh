...
echo -e "  ${BOLD_CYAN}║${RESET}        ${BOLD_WHITE}stildeeneca17-dots${RESET}                             ${BOLD_CYAN}║${RESET}"
echo -e "  ${BOLD_CYAN}║${RESET}        ${DIM}Personal dotfiles for macOS${RESET}                   ${BOLD_CYAN}║${RESET}"
echo -e "  ${BOLD_CYAN}╚══════════════════════════════════════════════════════╝${RESET}"
echo ""
...
echo ""
echo -e "  ${CYAN}┌─────────────────────────────────────────────────────┐${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Shell${RESET}        Fish ${DIM}(default)${RESET} + Zsh                       ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}carapace · zoxide · atuin · starship${RESET}     ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}direnv · Oh My Zsh · Powerlevel10k${RESET}       ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Multiplexer${RESET}  Tmux ${DIM}+ TPM + plugins (auto-installed)${RESET}  ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Editor${RESET}       Neovim ${DIM}(LazyVim · LSP · treesitter)${RESET}     ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}AI tools${RESET}     OpenCode · Claude · Codex · Gemini        ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}Engram · Gentle-AI · GGA${RESET}                 ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}CLI utils${RESET}    eza · bat · fzf · fd · delta · btop       ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}lazydocker · stern · xh · tldr · mkcert${RESET} ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}DevOps${RESET}       kubectl · helm · k9s · argocd · flux      ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}terraform · azure-cli · skopeo · docker${RESET}  ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Languages${RESET}    Node · Python (pyenv) · Deno              ${CYAN}│${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}pnpm · uv · poetry${RESET}                       ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Git${RESET}          gitconfig · gitignore · delta diffs       ${CYAN}│${RESET}"
echo -e "  ${CYAN}├─────────────────────────────────────────────────────┤${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Font${RESET}         MesloLGS Nerd Font                        ${CYAN}│${RESET}"
echo -e "  ${CYAN}└─────────────────────────────────────────────────────┘${RESET}"
echo ""
...
echo -e "  ${BOLD_GREEN}║${RESET}          ${BOLD_WHITE}✅  Installation complete!${RESET}                   ${BOLD_GREEN}║${RESET}"
echo -e "  ${BOLD_GREEN}╚══════════════════════════════════════════════════════╝${RESET}"
echo ""
