...
echo ""
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Shell${RESET}        Fish ${DIM}(default)${RESET} + Zsh"
echo -e "  ${CYAN}│${RESET}               ${DIM}carapace · zoxide · atuin · starship${RESET}"
echo -e "  ${CYAN}│${RESET}               ${DIM}direnv · Oh My Zsh · Powerlevel10k${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Multiplexer${RESET}  Tmux ${DIM}+ TPM + plugins (auto-installed)${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Editor${RESET}       Neovim ${DIM}(LazyVim · LSP · treesitter)${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}AI tools${RESET}     OpenCode · Claude · Codex · Gemini"
echo -e "  ${CYAN}│${RESET}               ${DIM}Engram · Gentle-AI · GGA${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}CLI utils${RESET}    eza · bat · fzf · fd · delta · btop"
echo -e "  ${CYAN}│${RESET}               ${DIM}lazydocker · stern · xh · tldr · mkcert${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}DevOps${RESET}       kubectl · helm · k9s · argocd · flux"
echo -e "  ${CYAN}│${RESET}               ${DIM}terraform · azure-cli · skopeo · docker${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Languages${RESET}    Node · Python (pyenv) · Deno"
echo -e "  ${CYAN}│${RESET}               ${DIM}pnpm · uv · poetry${RESET}"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Git${RESET}          gitconfig · gitignore · delta diffs"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo -e "  ${CYAN}│${RESET}  ${BOLD_MAGENTA}Font${RESET}         MesloLGS Nerd Font"
echo -e "  ${CYAN}──────────────────────────────────────────────────────${RESET}"
echo ""
